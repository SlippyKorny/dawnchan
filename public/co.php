...
<head>
    <meta charset="UTF-8">
    <title>/co/ - Comics & Cartoons - Dawnchan</title>
    ...
    <board_id style="display: none">5</board_id>
</head>
<body>
<nav>
    <div id="boards">
...
echo $img_tag;
?>
<h1 id="board-name">/co/ - Comics & Cartoons</h1>
...
<div id="newThread-container"><form id="newThread-form" action="../private/add_thread.php" method="post" enctype="multipart/form-data">
        ...
        echo "<input style='display: none' value='" . get_board_name_by_id($conn, 5) . "' name='board_name'>";
        ?>
    </form></div>
